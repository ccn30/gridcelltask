...
fprintf(fileID,'matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [-1 0.5 0.5];\n');
...
fprintf(fileID,'matlabbatch{3}.spm.stats.con.consess{2}.tcon.weights = [0 1 -1];\n');
...
fprintf(fileID,'matlabbatch{3}.spm.stats.con.consess{3}.fcon.weights = eye(3);\n');
