...
#! By: Coco Newton, based on Thomas Cope (tec31), based on Simon Jones (spj24) based on Paul Browne (pfb29)
#! 16 Jul 2019
#!#############################################################
...
#! Name of the job:
#SBATCH -J ENCRYPT_preprocessing
...
then
    ...
    export FREESURFER_HOME=/home/ccn30/freesurfer
